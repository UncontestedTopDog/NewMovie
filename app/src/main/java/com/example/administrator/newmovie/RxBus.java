...
public class RxBus {
    ...
    public <T> Observable<T> register(@NonNull final Class<T> cls, final Object lifecycleObject) {
        ...
        if (lifecycleObject instanceof com.trello.rxlifecycle.components.support.RxAppCompatActivity) {
            com.trello.rxlifecycle.components.support.RxAppCompatActivity rxFragment
                    = (com.trello.rxlifecycle.components.support.RxAppCompatActivity) lifecycleObject;
